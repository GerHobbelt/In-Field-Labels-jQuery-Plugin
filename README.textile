...
h2. Considering alternatives

See http://css-tricks.com/float-labels-css/ for a modern CSS-only approach.

Also be sure to read http://bradfrostweb.com/blog/post/float-label-pattern/ and the 'problems with this' article referenced from there: http://baymard.com/blog/mobile-forms-avoid-inline-labels
